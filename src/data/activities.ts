...
export const ACTIVITIES_DATA: ActivityData[] = [
  {
    ...
    subtitle: "매주 진행되는 세션",
    description:
      "대면/비대면으로 진행되는 다양한 세션을 통해 창업 및 IT 관련 활동을 진행해요.",
    details: [
      "매주 토요일 오프라인 세션 진행",
  ...
  },
  {
    ...
    description:
      "전국의 멋쟁이 사자들이 모여 서비스를 개발하는 연합 해커톤을 진행합니다.",
    details: [
      "전국 멋사 연합 해커톤 참가",
      "24~48시간 집중 개발",
      "기획부터 배포까지 풀 사이클 경험",
  ...
  },
  {
    ...
    subtitle: "기술 블로그 활동",
    description:
      "부원들이 직접 기술 블로그를 작성하며 배운 내용을 기록하고 공유해요. AI, React, Spring 등 다양한 주제를 다룹니다.",
    details: [
  ...
  },
  {
    ...
    subtitle: "파트 간 교류",
    description:
      "서로 다른 파트의 아기사자들이 모여 다양한 지식을 공유하고 친분을 쌓아요.",
    details: [
      "프론트/백엔드/기획 간 크로스 세션",
      "팀 빌딩 활동 및 네트워킹",
      "서로의 프로젝트 피드백",
  ...
  },
  {
    ...
    subtitle: "오리엔테이션",
    description:
      "새 학기를 시작하며 신규 아기사자들과의 첫 만남! 운영진 소개와 아이스브레이킹을 진행해요.",
    details: [
      "14기 운영진 소개",
      "학기 커리큘럼 안내",
      "아이스브레이킹 게임",
  ...
  },
  {
    ...
    subtitle: "멤버십 트레이닝",
    description:
      "맛있는 음식과 레크레이션으로 함께 친목을 도모해요. 1박 2일 프로그램!",
    details: [
      "학기 초 1박 2일 MT 진행",
      "팀 빌딩 게임 및 레크레이션",
      "바비큐 파티 & 캠프파이어",
  ...
  },
  {
    ...
    subtitle: "아이디어 피칭 대회",
    description:
      "기획파트들이 나머지 부원에게 매달 아이디어를 발표하고, 최종 5개 아이템을 선발해요.",
    details: [
      "매달 아이디어 피칭 세션",
  ...
  },
  {
    ...
    subtitle: "프로젝트 발표회",
    description:
      "한 학기 동안 진행한 프로젝트의 결과물을 발표하고, 전문가 심사로 수상자를 선발해요.",
    details: [
      "학기 말 전체 프로젝트 발표",
      "외부 심사위원 초청 심사",
      "최우수/우수/장려상 시상",
  ...
  },
  {
    ...
    subtitle: "현업 전문가 교류",
    description:
      "현업 개발자, 디자이너, 기획자들과의 네트워킹으로 실무 인사이트를 얻어요.",
    details: [
      "현업 종사자 초청 강연",
      "졸업 기수 선배와의 만남",
      "타 대학 멋사와의 연합 네트워킹",
