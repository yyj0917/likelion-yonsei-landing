...
export const PROJECTS: Project[] = [
  // ── 13기 프로젝트 ──
  {
    ...
    name: "2025 대동제",
    description:
      "연세대학교 개교 140주년 무악대동제 Scent of Blue 공식 웹사이트",
    ...
    githubUrl: {
      ...
      backend:
        "https://github.com/Likelion-Yonsei-13th/SCENT-YONSEI-SERVER.git",
    },
    ...
    awards: [
      "총 방문자: 10,772명에게 실시간 정보 제공",
      "사용자 참여도: 방문자당 평균 13.5페이지 조회",
      "사용자 경험: 16% 이탈률로 높은 사용자 경험 입증",
      "모바일 최적화: 93% 모바일 사용률로 현장 활용도 극대화",
    ],
  ...
  },
  {
    ...
    name: "NestOn",
    description:
      "사회초년생·대학생을 대상으로 매물 탐색부터 계약서 검토, 지역 정착까지 AI로 통합 지원하는 주거 플랫폼",
    ...
    githubUrl: {
      frontend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-FRONTEND-NestOn.git",
      backend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-BACKEND-Pawsitive.git",
    },
    deployUrl: "",
    team: [
  ...
  },
  {
    ...
    name: "IDEALAB",
    description:
      "지도 기반 AI 시뮬레이션을 통해 최적 입지와 예상 성과를 실시간으로 확인할 수 있는 예비 창업자 지원 플랫폼",
    ...
    githubUrl: {
      frontend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-FRONTEND-IDEALAB.git",
      backend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-BACKEND-IDEALAB.git",
    },
    team: [
  ...
  },
  {
    ...
    name: "픽플",
    description:
      "신촌 지역 요식업 소상공인을 위해 음식 사진 보정과 레퍼런스 탐색을 지원하는 AI 기반 브랜딩 플랫폼",
    ...
    githubUrl: {
      frontend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-FRONTEND-YonVoyage.git",
      backend:
        "https://github.com/Likelion-Yonsei-13th/13-HACKATHON-BACKTEND-YonVoyage.git",
    },
    deployUrl: "",
    team: [
  ...
  },
  {
    ...
    name: "쇼츠테이블",
    description:
      "사진·영상만 업로드하면 브랜드 맞춤 SNS 숏폼 홍보 영상을 자동 생성해주는 외식업 소상공인 대상 마케팅 플랫폼",
    ...
    techStack: ["NestJS", "Spring", "PostgreSQL", "Amazon S3", "OpenAI GPT"],
  },
  {
    id: 6,
    name: "돌봄온",
    description:
      "가족 간 간병 일정 조율과 기록 공유를 한 번에 해결하는 가족 간병 지원 플랫폼",
  ...
  },
  {
    ...
    name: "D-TOUR",
    description:
      "여행자 취향을 기반으로 로컬이 직접 맞춤 여행 일정을 설계해주는 여행 매칭 플랫폼",
    ...
    githubUrl: {
      frontend:
        "https://github.com/Likelion-Yonsei-13th/13-DEMODAY-FRONTEND-TEAM02.git",
      backend:
        "https://github.com/Likelion-Yonsei-13th/13-DEMODAY-BACKEND-TEAM02.git",
    },
    team: [
      { name: "강서현", role: "Design/PM" },
      { name: "백하나", role: "Design/PM" },
  ...
  },
  {
    ...
    name: "SAI",
    description:
      "악의적 반응 없이 질문을 중심으로 생각을 나누고 대화를 아카이빙할 수 있는 콘텐츠 기반 대화 플랫폼",
  ...
  },
  {
    ...
    name: "Mind-Window",
    description:
      "심리 전문가들의 매일 한 마디 위로 메시지를 통해 치료 문턱을 낮추는 심리 상담 유도 플랫폼",
  ...
  },
  {
    ...
    name: "ASSURE",
    description:
      "진단서 사진 업로드만으로 진단 기록 관리부터 보험금 청구까지 한번에 해결하는 헬스케어 플랫폼",
  ...
  },
  {
    ...
    name: "파수꾼",
    description:
      "치매 및 취약노인의 안전을 위해 신발 깔창형 GPS와 충격 감지 센서를 활용한 실시간 보호 서비스",
    ...
    team: [
      ...
      { name: "윤상민", role: "Frontend" },
      { name: "김지민", role: "Backend" },
      { name: "정승연", role: "Backend" },
    ],
    awards: ["2024년 하반기 워크스테이션 선정"],
  ...
  },
  {
    ...
    name: "또밥",
    description:
      "1인 가구를 위한 AI 기반 식료품 유통기한 관리 및 맞춤형 건강 레시피 추천 플랫폼",
  ...
  },
  {
    ...
    name: "Zero",
    description:
      "게임처럼 즐겁게 기록하는 현대인 맞춤형 웰니스 칼로리 밸런스 관리 웹 서비스",
    ...
    deployUrl: "",
    team: [{ name: "푸드바오", role: "Design/PM/Dev" }],
    awards: [""],
  ...
  },
  {
    ...
    name: "maniaX",
    description:
      "소셜링과 랭킹 시스템을 통해 확실한 동기부여를 제공하는 친구 공동 휴대폰 사용 시간 관리 솔루션",
  ...
  },
  {
    ...
    name: "ForHero",
    description:
      "감정 분석과 동료 네트워킹을 통해 소방관의 외상 후 스트레스 장애(PTSD)를 예방하고 관리하는 정신건강 지원 플랫폼",
