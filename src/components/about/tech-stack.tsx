...
const techStack: TechStackItem[] = [
  ...
  {
    name: 'Django',
    icon: <span className="text-2xl font-bold">dj</span>,
  ...
  {
    name: 'AWS',
    icon: <span className="text-2xl font-bold">aws</span>,
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          {techStack.map((tech) => (
            ...
            >
              <div
                className={`${tech.bgColor} w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center text-white shadow-lg transition-transform duration-300 group-hover:scale-110`}
              >
                {tech.icon}
              </div>
